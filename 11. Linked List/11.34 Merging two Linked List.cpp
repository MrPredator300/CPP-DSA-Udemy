...
int main()
{
 ...
 Concat(first,second);          //Displays the first linked List A and then the second Linked List B
 //Concat(second,first);        //Displays the second linked List B and then the first Linked List A
 ...
 */
 ...
 /*
 cout<<"First:"<<endl;
 display(first);        // Displaying the 1st Linked List i.e A
 cout<<endl;
 cout<<"Second:"<<endl;
 display(second);       // Displaying the 2nd Linked List i.e B
 cout<<endl;
 */
